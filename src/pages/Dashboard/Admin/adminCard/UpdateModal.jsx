...
const UpdateModal = ({ onClose }) => {
    ...
    const handleSubmit = (event) => {
        ...
        axios.update("http://localhost:5000/sessions", formData)
            .then(res => {
    ...
    return (
        <div className="bg-white p-8 rounded-lg shadow-md my-6 max-w-lg mx-auto relative">
            <button
                onClick={onClose}
            ...
            <h2 className="text-2xl font-bold mb-6 text-gray-800">Update Study Session</h2>
